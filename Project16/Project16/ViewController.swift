...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "MapStype", style: .plain, target: self, action: #selector(changeMapType))
    ...
    @objc func changeMapType() {
        let ac = UIAlertController(title: "Changing the style of the map", message: nil, preferredStyle: .actionSheet)
